		...
		<div style="margin:50px; font-size:14pt;">
			<div style="margin:50px; font-size:14pt; border-bottom:5px solid darkgray;">
				<nav style="margin-bottom:10px;">
					<span class="header" style="float:none;color:#00361d">Houston</span> |
					<a class="header" style="float:none;color:#00361d" href="Austin.php">Austin</a> |
			...
			<div style="margin:50px;">
				<?php
					...
					try {
						...
						// perform query
						$query = "SELECT locationName, locationStreet, locationCity, locationState, locationZip FROM locations WHERE locationCity like 'Houston'";  
						$stmt = $db->prepare($query);  
						$stmt->bindParam('Houston', $locationCity);
						$stmt->execute(); 

						// get number of returned rows  
						echo "<h2>Houston locations: ".$stmt->rowCount()."</h2>"; 
